...
namespace CibertecAPI.Controllers
{
    ...
    public class ProductoController : Controller
    {
        ...
        // GET api/values/5
        [HttpGet("{id}")]
        public Producto Get(int id) => _productoBusiness.GetProducto(id);
        ...
        public void Delete(int id) => _productoBusiness.DeleteProducto(new Producto { Id = id });
        [HttpPost]
        [Route("GetProductos")]
        ...
        public void InsertarProducto(Producto producto,ICollection<IFormFile> files)
        {
            if (files.Count > 0)
            {
        ...
        {
            _productoBusiness.UpdateProductoBd(producto);
        }
    }
